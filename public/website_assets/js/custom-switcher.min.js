...
function switcherClick() {
  ...
  let backgroundColor1Var = bgDefaultColor1Btn.addEventListener("click", () => {
    ...
    document
      .querySelector("html")
      .style.setProperty("--light-rgb", "17, 31, 96");
    document
      .querySelector("html")
      .style.setProperty("--form-control-bg", "rgb(17, 31, 96)");
    document
      .querySelector("html")
      .style.setProperty("--input-border", "rgba(255,255,255,0.1)");
    document
      .querySelector("html")
      .style.setProperty("--gray-3", "rgba(255,255,255,0.1)");
  ...
  let backgroundColor2Var = bgDefaultColor2Btn.addEventListener("click", () => {
    ...
    document
      .querySelector("html")
      .style.setProperty("--light-rgb", "57, 16, 120");
    document
      .querySelector("html")
      .style.setProperty("--form-control-bg", "rgb(57, 16, 120)");
    document
      .querySelector("html")
      .style.setProperty("--input-border", "rgba(255,255,255,0.1)");
    document
  ...
  let backgroundColor3Var = bgDefaultColor3Btn.addEventListener("click", () => {
    ...
    document
      .querySelector("html")
      .style.setProperty("--light-rgb", "27, 101, 133");
    document
      .querySelector("html")
      .style.setProperty("--form-control-bg", "rgb(27, 101, 133)");
    document
      .querySelector("html")
      .style.setProperty("--input-border", "rgba(255,255,255,0.1)");
    document
  ...
  let backgroundColor4Var = bgDefaultColor4Btn.addEventListener("click", () => {
    ...
    document
      .querySelector("html")
      .style.setProperty("--light-rgb", "8, 99, 75");
    document
      .querySelector("html")
      .style.setProperty("--form-control-bg", "rgb(8, 99, 75)");
    document
      .querySelector("html")
      .style.setProperty("--input-border", "rgba(255,255,255,0.1)");
    document
  ...
  let backgroundColor5Var = bgDefaultColor5Btn.addEventListener("click", () => {
    ...
    document
      .querySelector("html")
      .style.setProperty("--light-rgb", "84, 89, 4");
    document
      .querySelector("html")
      .style.setProperty("--form-control-bg", "rgb(84, 89, 4)");
    document
      .querySelector("html")
      .style.setProperty("--input-border", "rgba(255,255,255,0.1)");
    document
