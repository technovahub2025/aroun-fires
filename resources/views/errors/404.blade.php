...
<head>
    ...
    <title> 404 | Aroun Systems & Safety Equipments </title>
                ...
                <div class="my-auto">
                    <div class="row align-items-center justify-content-center h-100">
                        <div class="col-xl-7 col-lg-5 col-md-6 col-12">
                            ...
                            <p class="fs-15 mb-5 text-muted">The requested page is not available. It might have been
                                relocated, deleted, or never existed.</p>
                            <a href="javascript:history.back()" class="btn btn-primary"><i
                                    class="ri-arrow-left-line align-middle me-1 d-inline-block"></i> BACK TO HOME
                                PAGE</a>
                        </div>
                    </div>
                </div>
