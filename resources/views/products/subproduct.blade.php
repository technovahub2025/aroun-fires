...
<body>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header">
                                <h1 class="page-title fw-medium fs-18 mb-0">Sub-Product List</h1>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered text-nowrap w-100 pt-2"
                                        ...
                                        <tbody>
                                            @foreach ($subproducts as $key => $subproduct)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td>{{ $subproduct->mainproduct->product_name ?? '' }}</td>
                                                    <td>{{ $subproduct->name }}</td>
                                                    <td>₹{{ $subproduct->price }}</td>
                                                    <td class="text-center"><a
                                                            href="dynamic_images/{{ $subproduct->image }}"
                                                            target="_blank"><img
                                                                src="dynamic_images/{{ $subproduct->image }}"
                                                                alt=""
                                                    ...
                                                    <td
                                                        ...
                                                        @if (strlen($subproduct->description) > 100)
                                                            <span
                                                                id="short-description">{{ substr($subproduct->description, 0, 100) }}...</span>
                                                        ...
                                                        @else
                                                            <span
                                                                id="full-description">{{ $subproduct->description }}</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center"><button class="btn btn-primary edit-btn"
                                                            data-id="{{ $subproduct->id }}">Edit</button> &nbsp;
                                                        <button class="btn btn-danger deletebtn"
                                                            data-id="{{ $subproduct->id }}">Delete</button>
                                                    </td>
                                                    <td>{{ $subproduct->crm_name }}</td>
                                                    <td>{{ $subproduct->created_log }}</td>
                                                    <td>{{ $subproduct->updated_log }}</td>
                                                </tr>
                                            @endforeach
                                ...
                                <div class="modal fade" id="modaldemo8" data-bs-backdrop="static"
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered text-center"
                                        ...
                                        <div class="modal-content modal-content-demo">
                                            <div class="modal-header">
                                                <h6 class="modal-title">Add Sub-Product</h6>
                                                <button aria-label="Close" class="btn-close"
                                                    data-bs-dismiss="modal"></button>
                                            </div>
                                            <div class="modal-body text-start">
                                                <div class="mb-3">
                                                    <label for="adminName" class="form-label">Main Product
                                                        Name</label>
                                                    <select name="mainproduct" id="mainproduct" class="form-control">
                                                        <option value="" selected disabled>Select Main Product
                                                        </option>
                                                        @foreach ($mainproducts as $mainproduct)
                                                            <option value="{{ $mainproduct->id }}">
                                                                {{ $mainproduct->product_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                        <label for="subproduct" class="form-label">Sub-product
                                                            Name</label>
                                                        <input type="text" name="subproduct" id="subproduct"
                                                            class="form-control" placeholder="Enter Sub-product Name">
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label for="adminName" class="form-label">Product URL</label>
                                ...
                                <div class="modal fade" id="editmodaldemo8" data-bs-backdrop="static"
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered text-center"
                                        ...
                                        <div class="modal-content modal-content-demo">
                                            <div class="modal-header">
                                                <h6 class="modal-title">Edit Sub-Product</h6><button
                                            ...
                                            <div class="modal-body text-start">
                                                <div class="mb-3">
                                                    <label for="adminName" class="form-label">Main Product
                                                        Name</label>
                                                    <select name="mainproduct" id="editmainproduct"
                                                        class="form-control">
                                                        <option value="" selected disabled>Select Main Product
                                                        </option>
                                                        @foreach ($mainproducts as $mainproduct)
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                        <label for="subproduct" class="form-label">Sub-product
                                                            Name</label>
                                                        <input type="text" name="subproduct" id="editsubproduct"
                                                            class="form-control" placeholder="Enter Sub-product Name">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="price" class="form-label">Price</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#submit-btn').click(function(e) {
                ...
                if ($('#mainproduct').val() === '' || $('#mainproduct').val() == null) {
                    $('#mainproduct').addClass('is-invalid');
                    isvalid = false;
                }
                if ($('#subproduct').val() === '' || $('#subproduct').val() == null) {
                    $('#subproduct').addClass('is-invalid');
                    isvalid = false;
                }
                if ($('#subproduct').val() === '' || $('#subproduct').val() == null) {
                    $('#subproduct').addClass('is-invalid');
                ...
                if ($('#producturl').val() === '') {
                    $('#producturl').addClass('is-invalid');
                    isvalid = false;
                }
                ...
                if (isvalid) {
                    ...
                    canvas.toBlob((blob) => {
                        const formData = new FormData();
                        formData.append('croppedImage', blob);
                        formData.append('mainproduct', $('#mainproduct').val());
                        formData.append('subproduct', $('#subproduct').val());
                        formData.append('price', $('#price').val());
                        formData.append('description', $('#description').val());
                        formData.append('url', $('#producturl').val());
                        formData.append('_token', '{{ csrf_token() }}');

                        $.ajax({
                            url: '{{ route('insertsubproduct') }}',
                            type: 'POST',
                            data: formData,
                            contentType: false,
                            processData: false,
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status == '200' && response.data) {
                            $('#editmainproduct').val(response.data.main_product_id);
                            $('#editsubproduct').val(response.data.name);
            ...
            $('#update-btn').click(function(e) {
                ...
                if ($('#editmainproduct').val() == '' || $('#editmainproduct').val() == null) {
                    $('#editmainproduct').addClass('is-invalid');
                    isvalid = false;
                }
                if ($('#editsubproduct').val() == '' || $('#editsubproduct').val() == null) {
                    $('#editsubproduct').addClass('is-invalid');
                    isvalid = false;
                }
                if ($('#editprice').val() == '' || $('#editprice').val() == null) {
                    ...
                    if (isimageupload) {
                        ...
                        canvasedit.toBlob((blob) => {
                            if (blob) {
                                ...
                                formData.append('mainproduct', $('#editmainproduct').val());
                                formData.append('subproduct', $('#editsubproduct').val());
                                formData.append('price', $('#editprice').val());
                                formData.append('description', $('#editdescription').val());
                                formData.append('id', $('#editids').val());
                                formData.append('_token', '{{ csrf_token() }}');
                                $.ajax({
                                    url: '{{ route('updatesubproduct') }}', // Update this URL if necessary
                                    type: 'POST',
                                    data: formData,
    ...
    <script>
        ...
        const productInput = document.getElementById('producturl');
    ...
    <script>
        ...
        const sourceInput = document.getElementById('subproduct');
        const destinationInput = document.getElementById('producturl');
